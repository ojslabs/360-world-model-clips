...
detail while enlarging generated frames. `config/orbit_preset.json` owns the fixed prompt,
model settings and original Around path. `app/orbit_paths.py` derives the selectable
